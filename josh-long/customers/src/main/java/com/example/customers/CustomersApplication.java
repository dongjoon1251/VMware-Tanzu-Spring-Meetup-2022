...
class Initializer implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		var names = Flux.just("Josh", "Olga", "Madhura", "Dr. Syer", 
						"Yuxin", "Violetta", "Madhura", "Stephane")
...
// pros of reactive programing
// 1 safe, functional multithreaded java code
// 2 composition
// 3 reliability

// project loom: cheap thread pool ability to use thread quickly
